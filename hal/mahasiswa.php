		...
		if(mysql_num_rows($query) == 0){	//ini artinya jika data hasil query di atas kosong
			...
			while($data = mysql_fetch_assoc($query)){	//perulangan while dg membuat variabel $data yang akan mengambil data di database
				...
				echo '<tr>';
					...
					echo '<td><a href="delete.php?No_induk='.$Nomor_induk.'" ><strong>Delete</strong></a> |<a href="edit.php?No_induk='.$Nomor_induk.'"><strong>Edit</strong></a>';	//menampilkan link edit dan hapus dimana tiap link terdapat GET id -> ?id=siswa_id
				echo '</tr>';
