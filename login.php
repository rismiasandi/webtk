...
@session_start(); 
	if(isset($_POST['Submit'])){
		...
		$logins = array('Habibi' => '123456','username' => 'password','username2' => 'password2');
		...
		$_SESSION['UserData']['Username']=$logins[$Username];
			header("location:contact.php?page=mahasiswa");
			exit;
		} else {
	...
	<div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Anda Harus Login Dulu
...
<form action="" method="post" name="Login_Form"><center>
    ...
    <?php } ?>
    <tr>
      <td colspan="2" align="left" valign="top"><h3>Login</h3></td><br/>
    </tr>
    <tr>
